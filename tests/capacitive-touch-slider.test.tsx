...
/**
 * Capacitive Touch Slider — polygon smtpads with solder mask
 *
 * Demonstrates the use case from tscircuit/tscircuit#786:
 * polygon-shaped SMT pads covered with solder mask form the capacitive
 * sensing electrodes. The solder mask acts as a dielectric layer between
 * the user's finger and the copper, enabling touch detection.
 */
...
test("capacitive touch slider - polygon smtpads with coveredWithSolderMask", async () => {
  ...
  expect(new Set(centroids).size).toBe(NUM_PADS)
})
